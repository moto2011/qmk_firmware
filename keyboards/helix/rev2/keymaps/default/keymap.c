...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Esc  | Alt  | GUI  | GUI  |Lower |Space |Enter |Raise | GUI  | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = KEYMAP( \
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, KC_LGUI,    LOWER,   KC_SPC,  KC_ENT,  RAISE,   KC_RGUI,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
